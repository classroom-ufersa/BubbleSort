...
void OrdenaAlunos(int n, Aluno *Vet){
    ...
    { 
        ...
        { 
            ...
            r = strcmp(Vet[i].nome, Vet[j].nome); // 1 vez: c1
            ...
            if (r > 0) // 1 vez: c2
            { 
                strcpy(temp, Vet[i].nome); // 1 vez: c3
                strcpy(Vet[i].nome, Vet[j].nome); // 1 vez: c4
                strcpy(Vet[j].nome, temp); // 1 vez: c5
            }
        }
    }
}
